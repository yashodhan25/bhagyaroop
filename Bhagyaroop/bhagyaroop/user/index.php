                            ...
                            <div class="row">
                                <div class="col-md-12 mx-0">          
                                    ...
                                    <ul id="progressbar" style="margin-left: 40px;" class="pro">
                                        <a href="./?step=1" id="route_1"><li id="confirm"><strong>Personal Information</strong></li></a>
                                        <a href="./?step=2" id="route_2"><li id="confirm"><strong>Educational Information</strong></li></a>
                                        <a href="./?step=3" id="route_3"><li id="confirm"><strong>Professional Information</strong></li></a>
                                        <a href="./?step=4" id="route_4"><li id="confirm"><strong>Horoscope Information</strong></li></a>
                                        <a href="./?step=5" id="route_5"><li id="confirm"><strong>Habits And Information</strong></li></a>
                                        <a href="./?step=6" id="route_6"><li id="confirm"><strong>Contact Information</strong></li></a>
                                        <a href="./?step=7" id="route_7"><li id="confirm"><strong>Reference</strong></li></a>
                                        <a href="./?step=8" id="route_8"><li id="confirm"><strong>Family Information</strong></li></a>
                                        <a href="./?step=9" id="route_9"><li id="confirm"><strong>Expectations</strong></li></a>
                                    </ul>
                                                ...
                                                <h2 class="fs-title" style="color:#3498DB;">Educational Information</h2> 
                                                    <div class="row">
                                                        ...
                                                        <div class="col-sm-12 col-md-12 col-lg-6">
                                                            ...
                                                            <select class="list-dt" id="edv" name="edf" onchange="fun5()">
                                                            <?php
                                                            if($v24 == ""){
                                                                ?>
                                                ...
                                                <div class="form-card">
                                                    ...
                                                    <div class="row">
                                                        ...
                                                        <div class="line"></div>
                                                            ...
                                                            <select class="list-dt" name="annin">
                                                                <?php
                                                                if($v37 == ""){
                                                                    ?>
                                            ...
                                            <div class="form-card">
                                                ...
                                                <div class="row">
                                                    ...
                                                    <div class="col-sm-12 col-md-12 col-lg-12" style="">
                                                        ...
                                                        <input type="text" name="addr" placeholder="" style="width:70%" value="<?php echo $v65 ?>" />
                                                    </div>
...
<?php
if(isset($_GET['a'])){
    echo "<script> alert('Data Saved successfully. Please go to the upload documents !'); </script>";
}
if(isset($_GET['x'])){
