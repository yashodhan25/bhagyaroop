...
if($_POST['step'] == 1){
    ...
    if($run){
        header('location:./?x=1&step=2');
    }else{
        //header('location:./?q=1&step=1');
...
if($_POST['step'] == 2){
    ...
    if($run){
        header('location:./?x=1&step=3');
    }else{
        header('location:./?q=1&step=2');
        //echo "Error !".mysqli_error($con);
    }
...
if($_POST['step'] == 3){
    ...
    if($run){
        header('location:./?x=1&step=4');
    }else{
        header('location:./?q=1&step=3');
        //echo "Error !".mysqli_error($con);
    }
}
...
if($_POST['step'] == 4){
    ...
    if($run){
        header('location:./?x=1&step=5');
    }else{
        header('location:./?q=1&step=4');
        //echo "Error !".mysqli_error($con);
    }
}
...
if($_POST['step'] == 5){
    ...
    if($run){
        header('location:./?x=1&step=6');
    }else{
        header('location:./?q=1&step=5');
        //echo "Error !".mysqli_error($con);
    }
}
...
if($_POST['step'] == 6){
    ...
    if($run){
        header('location:./?x=1&step=7');
    }else{
        header('location:./?q=1&step=6');
        //echo "Error !".mysqli_error($con);
    }
...
if($_POST['step'] == 7){
    ...
    if($run){
        header('location:./?x=1&step=8');
    }else{
        header('location:./?q=1&step=7');
        //echo "Error !".mysqli_error($con);
    }
...
if($_POST['step'] == 8){
    ...
    if($run){
        header('location:./?x=1&step=9');
    }else{
        header('location:./?q=1&step=8');
        //echo "Error !".mysqli_error($con);
    }
...
if($_POST['step'] == 9){
    ...
    if($run){
        header('location:./?a=1&step=9');
    }else{
        header('location:./?q=1&step=9');
        //echo "Error !".mysqli_error($con);
    }
