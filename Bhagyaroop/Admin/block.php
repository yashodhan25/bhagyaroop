        ...
        <nav class="navbar">
          <div class="container-fluid">
            ...
            <ul class="nav navbar-nav">
              ...
              <li class="active"><a href="./block.php">Block User</a></li>
            </ul>
                    ...
                    <tbody>
                      ...
                      for($x=1; $x<=$row; $x++){
                        ...
                        <tr>
                          ...
                          <?php
                          $blockStatus = mysqli_num_rows(mysqli_query($con, "SELECT * FROM `blocklist` WHERE `email`='$email' AND `status`='blocked' "));
                          if($blockStatus == 0){
                            ?>
                            <td><a href="blocker.php?email=<?php echo $email; ?>"><button>Block</button></a></td>
                            <?php
                          }else{
                            ?>
                            <td><a href="unblocker.php?email=<?php echo $email; ?>"><button>Unblock</button></a></td>
                            <?php
                          }
                          ?>
